...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Bruno\n' // Nome do dono 
            + 'ORG:BrunoBot;\n' // Nome do Bot
            + 'TEL;type=CELL;type=VOICE;waid=558688275801:+55 47992091566\n' //número do zapo
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD BRUNO BOT*',
			...
			const ownerNumber = ["558688275801@s.whatsapp.net"] //número do dono
			const mod = [ownerNumber,"558688275801@s.whatsapp.net"]//mod
			const adminbotnumber = ["558688275801@s.whatsapp.net"]//adm
			const frendsowner = ["558688275801@s.whatsapp.net"]//amigos 
			const premium = ["558688275801@s.whatsapp.net","554199856977@s.whatsapp.net"]//Premium 
			...
			case 'closegp':
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'tts':
					...
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Bruno ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: msg })
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: msg, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/558688275801/*╰──────*「 * BRUNO* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO BRUNO BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: msg, caption: '*CRIADOR:* BRUNO\n*WPP:* wa.me/+5586988275801\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
